...
function himalayas_widgets_init() {
   ...
   register_sidebar( array(
    ...
    register_sidebar( array(
        'name'            => esc_html__( 'Left right_blog_widget', 'himalayas' ),
        'id'              => 'right_blog_widget',
        'description'     => __( 'Shows widgets at Left side.', 'himalayas' ),
        'before_widget'   => '<aside id="%1$s" class="widget %2$s clearfix">',
        'after_widget'    => '</aside>',
        'before_title'    => '<h4 class="widget-title"><span>',
...
<?php } ?>
               <?php if( $page_id ) :
                   ...
                   ?>
               <div class="about-content-wrapper<?php if( has_post_thumbnail() ) { echo ' tg-column-wrapper';} ?> clearfix">
                  <?php


                     if( has_post_thumbnail() ) { ?>
                        <div class="about-image tg-column-2">
                           <?php the_post_thumbnail( 'himalayas-featured-abt' ); ?>
                        </div>
                     <?php } ?>

                     <div class="about-content<?php if( has_post_thumbnail() ) { echo ' tg-column-2';} ?>">
                        <?php
                        $output = '<h2 class="about-title"> <a href="' . get_permalink() . '" title="' . $title_attribute . '" alt ="' . $title_attribute . '">' . get_the_title() . '</a></h2>';

                        $output .= '<div class="about-content">' . '<p>' . get_the_content() . '</p></div>';
...
class himalayas_call_to_action_widget extends WP_Widget {
   function __construct() {
      $widget_ops = array( 'classname' => 'widget_call_to_action_block CTA_color', 'description' => __( 'Use this widget to show the call to action section.', 'himalayas' ) );
      $control_ops = array( 'width' => 200, 'height' =>250 );
                        ...
                        <div class="tg-column-3 tg-column-bottom-margin">
                           <div class="team-block">
                              ...
                              <div class="team-img-wrapper">
                                 ...
                                 <div class="team-img">
                                    <?php if( has_post_thumbnail() ) {
                                       the_post_thumbnail( 'himalayas-featured-abt' );
