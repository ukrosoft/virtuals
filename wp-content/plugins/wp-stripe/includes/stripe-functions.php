...
function wp_stripe_shortcode( $atts ) {
	...
	$url     = add_query_arg( array( 'wp-stripe-iframe' => 'true', 'keepThis' => 'true','title'=>$atts['title'] , 'amount'=> $atts['amount'] , 'TB_iframe' => 'true',  'width' => 420 ), home_url() );
	$count   = 1;
...
function wp_stripe_shortcode_legacy( $atts ){
	return wp_stripe_form_bootstrap();
}
