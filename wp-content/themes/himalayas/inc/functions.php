...
//   wp_enqueue_style( 'himalayas-google-fonts', '//fonts.googleapis.com/css?family=Crimson+Text:700|Roboto:400,700,900,300' );
    ...
    wp_enqueue_script( 'himalayas-featured-image-popup', HIMALAYAS_JS_URL. '/magnific-popup/jquery.magnific-popup.min.js', array( 'jquery' ), '1.0.0', true  );

   // Load fontawesome
   wp_enqueue_style( 'himalayas-fontawesome', get_template_directory_uri() . '/font-awesome/css/font-awesome.min.css', array(), '4.3.0' );
   wp_enqueue_style( 'bootstrap', get_template_directory_uri() . '/bootstrap/css/bootstrap.min.css', array(), '4.3.0' );
    wp_enqueue_script( 'bootstrap-js', get_template_directory_uri() . '/bootstrap/js/bootstrap.min.js', array( 'jquery' ), '1.0.0', true  );
